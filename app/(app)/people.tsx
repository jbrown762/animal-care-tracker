...
export default function PeopleScreen() {
  const { activeRole, invitations, inviteMember, isAdmin, memberships, removeMember, revokeInvitation, updateRole } = useOrg();
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        title="People & Roles"
        description="Manage organization members, roles, and pending invitation links."
      />
      ...
      {isAdmin ? (
        ...
        <Card>
          ...
          <Text style={styles.muted}>Member management and invitations are available to Admins.</Text>
        </Card>
      )}
    </AppShell>
  );
